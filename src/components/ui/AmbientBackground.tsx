    ...
    <div className="fixed inset-0 -z-50 w-full h-full bg-[#020204] overflow-hidden pointer-events-none">
      ...
      <div
        className={cn(
          ...
          !shouldReduceMotion && "animate-subtle-drift",
        )}
      />
      <div
        className={cn(
          "absolute bottom-[-10%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-gradient-to-tr from-[#7000ff] to-[#00ff87] opacity-[0.06] blur-[140px] [animation-delay:4s]",
          !shouldReduceMotion && "animate-subtle-drift",
        )}
      />
